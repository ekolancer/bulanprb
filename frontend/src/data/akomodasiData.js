    ...
    routes: [
      {
        ...
        plateNumber: 'B 7231 PRB',
        from: 'Bandara Soekarno-Hatta',
        to: 'Hotel Area Kemayoran',
        departureTime: '12:00',
        capacity: 14,
        contact: '+62 812-0001-1122',
        note: 'Tunggu di pintu kedatangan Terminal 3',
      },
      {
        id: 's1-2',
        type: 'Bus BNPB Armada B',
        plateNumber: 'B 9042 BNP',
        from: 'Stasiun Gambir',
        to: 'Hotel Area Kemayoran',
        departureTime: '10:00',
        capacity: 45,
        contact: '+62 812-0002-3344',
  ...
  'D0': {
    ...
    routes: [
      ...
      },
      {
        ...
        plateNumber: 'B 5518 BNP',
        from: 'Halte TransJakarta Cempaka Putih',
        to: 'Gedung BNPB',
        departureTime: '07:00',
        capacity: 45,
        contact: '+62 812-0003-5566',
